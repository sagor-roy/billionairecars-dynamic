...
class AdminbrandController extends Controller {
	...
	{		
		...
		$this->model = new Adminbrand();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'adminbrand',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('adminbrand');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('adminbrand.public.view',$data);			
			}			
		} 
		else {
			...
			return view('adminbrand.public.index',$data);	
		}
