...
class AdminhomesliderController extends Controller {
	...
	{		
		...
		$this->model = new Adminhomeslider();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'adminhomeslider',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('adminhomeslider');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('adminhomeslider.public.view',$data);			
			}			
		} 
		else {
			...
			return view('adminhomeslider.public.index',$data);	
		}
