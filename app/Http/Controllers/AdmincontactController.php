...
class AdmincontactController extends Controller {
	...
	{		
		...
		$this->model = new Admincontact();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'admincontact',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('admincontact');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('admincontact.public.view',$data);			
			}			
		} 
		else {
			...
			return view('admincontact.public.index',$data);	
		}
