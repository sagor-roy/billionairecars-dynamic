...
class AdminproductController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('adminproduct');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('adminproduct.public.view',$data);			
			}			
		} 
		else {
			...
			return view('adminproduct.public.index',$data);	
		}
