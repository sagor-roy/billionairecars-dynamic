...
use App\Models\Admincarplan;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 

class AdmincarplanController extends Controller {

	protected $layout = "layouts.main";
	protected $data   = array();	
	public $module 	  = 'admincarplan';
	static $per_page  = '20';
	...
	{		
		...
		$this->model = new Admincarplan();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'admincarplan',
	...
	public static function display(  )
	{
		...
		$model= new Admincarplan();
		$info = $model::makeInfo('admincarplan');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('admincarplan.public.view',$data);			
			}			
		} 
		else {
			...
			return view('admincarplan.public.index',$data);	
		}
