...
class AdminsocialmediaController extends Controller {
	...
	public $module 	  = 'adminsocialmedia';
	static $per_page  = '20';
	...
	{		
		...
		$this->model = new Adminsocialmedia();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'adminsocialmedia',
	...
	public static function display(  )
	{
		...
		$model= new Adminsocialmedia();
		$info = $model::makeInfo('adminsocialmedia');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('adminsocialmedia.public.view',$data);			
			}			
		} 
		else {
			...
			return view('adminsocialmedia.public.index',$data);	
		}
