...
class AdminfaqsController extends Controller {
	...
	{		
		...
		$this->model = new Adminfaqs();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'adminfaqs',
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] 	= $id;
				return view('adminfaqs.public.view',$data);			
			}			
		} 
		else {
			...
			return view('adminfaqs.public.index',$data);	
		}
