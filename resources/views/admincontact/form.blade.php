...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'admincontact?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="col-md-12">
						<fieldset><legend> Contact</legend>
				           ...
				           >{{ $row['message'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										<label for="Seen" class=" control-label col-md-4 text-left"> Seen </label>
										<div class="col-md-6">
										  <input  type='text' name='seen' id='seen' value='{{ $row['seen'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("admincontact/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
