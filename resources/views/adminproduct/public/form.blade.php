...
<div class="col-md-12">
    <fieldset>
        ...
        <div class="form-group row  ">
            <label for="Short Description (Spanish)" class=" control-label col-md-4 text-left"> Short Description
                (Spanish) </label>
            <div class="col-md-6">
                        ...
                        @if (file_exists('./uploads/product/gallery/' . $files) && $files != '')
                            <li id="cr-<?php echo $cr; ?>" class="">
                                <a href="{{ url('/uploads/product/gallery//' . $files) }}" target="_blank">
                                    <img src="{{ url('/uploads/product/gallery//' . $files) }}" alt="img">
                                </a>
        ...
        <div class="form-group row  ">
            <label for="Accessories (Spanish)" class=" control-label col-md-4 text-left"> Accessories (Spanish)
            </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="License Plate Details" class=" control-label col-md-4 text-left"> License Plate Details
            </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="License Plate Details (Spanish)" class=" control-label col-md-4 text-left"> License Plate
        ...
        <div class="form-group row  ">
            <label for="Financial Details (Spanish)" class=" control-label col-md-4 text-left"> Financial Details
                (Spanish) </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="Technical Data (Spanish)" class=" control-label col-md-4 text-left"> Technical Data (Spanish)
            </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="Vehicle Data Specific" class=" control-label col-md-4 text-left"> Vehicle Data Specific
            </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="Vehicle Data Specific (Spanish)" class=" control-label col-md-4 text-left"> Vehicle Data
                Specific (Spanish) </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="Environmental Data (Spanish)" class=" control-label col-md-4 text-left"> Environmental Data
                (Spanish) </label>
            <div class="col-md-6">
        ...
        <div class="form-group row  ">
            <label for="Other Information (Spanish)" class=" control-label col-md-4 text-left"> Other Information
                (Spanish) </label>
            <div class="col-md-6">
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <button type="submit" name="apply" class="btn btn-default btn-sm"><i class="fa  fa-check-circle"></i>
            {{ Lang::get('core.sb_apply') }}</button>
        <button type="submit" name="submit" class="btn btn-default btn-sm"><i class="fa  fa-save "></i>
